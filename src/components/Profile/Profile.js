...
const Profile = (props) => {
    ...
    const editPost = (post_id) => {
        axios.put(`/api/editPost/${post_id}`, {title, content, img_url}).then(res => {
            getUsersPosts()
            toggleEdit();
        }).catch(err => console.log(err))
    };
            ...
            return <div className="profile-post-box" key={posts.post_id}>
                        {!editing  ? (
                            ...
                            <section className="profile-post-content">
                                <p>{posts.content}</p>
                                <img img className="post-img" src={posts.img_url} alt=""></img>
                            </section>
                            ...
                            <section className="profile-post-content">
                                <p>{posts.content}</p>
                                <img className="post-img" src={posts.img} alt=""></img>
                            </section>
                            <div className="profile-buttons">
                            ...
                            <div className="edit-inputs">
                                ...
                                <input className="edit-content" type="text"  name="content" placeholder="Edit Post Here...." value={content} onChange={(e) => setContent(e.target.value)}/>
                            </div>
